...
const Semester = () => {
    ...
    const handleClickPrint = async (e) => {
        ...
        if (fromYear > toYear) {
            ...
            localStorage.setItem('printData', JSON.stringify(saveLocal));
            navigate(`/student/semester/print/${id}`);
        }
    }
    ...
    return (
        <section className='content-main'>
            <div className="content-header mb-0">
                <div className="flex flex-row gap-5 m-5">
                    <div className='p-1 rounded-md border-2 border-black'>
                        <Link to={`/student/result/${id}`} className="flex justify-between">
            ...
            <div className='table-content my-4'>
                <h6 className='border mx-auto py-0.5'>Thông số in bảng điểm cá nhân của sinh viên</h6>
                <table className='border table my-0 mx-auto'>
                    <tbody className='py-10'>
                        <tr>
                            <td colSpan={2}><br /></td>
                        </tr>
                        <tr>
                            <td className='text-right'>In tất cả học kỳ </td>
